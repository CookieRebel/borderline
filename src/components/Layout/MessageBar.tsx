...
const MessageBar = ({ status, message, onShowResults }: MessageBarProps) => {
    const isGameOver = status === 'won' || status === 'lost' || status === 'given_up';
    ...
    return (
        <div className="d-flex align-items-center justify-content-between mb-1 slide-in gap-2">
            <span
